...
export type InstanceSetting_AISetting = Message<"memos.api.v1.InstanceSetting.AISetting"> & {
  ...
  /**
   * writing is the AI writing-assistant feature configuration.
   * When unset or writing.provider_id is empty, writing is disabled.
   *
   * @generated from field: memos.api.v1.InstanceSetting.WritingConfig writing = 4;
   */
  writing?: InstanceSetting_WritingConfig | undefined;
};
...
/**
 * WritingConfig configures the AI writing-assistant feature.
 * Uses the OpenAI Chat Completions protocol against any compatible endpoint.
 *
 * @generated from message memos.api.v1.InstanceSetting.WritingConfig
 */
export type InstanceSetting_WritingConfig = Message<"memos.api.v1.InstanceSetting.WritingConfig"> & {
  /**
   * provider_id references an entry in AISetting.providers[].id.
   * Empty string means writing is disabled.
   *
   * @generated from field: string provider_id = 1;
   */
  providerId: string;
  ...
  /**
   * model is the provider-specific chat model identifier.
   * Empty string falls back to the engine default.
   *
   * @generated from field: string model = 2;
   */
  ...
  /**
   * system_prompt is an instance-level system instruction applied to every
   * writing-assistant call. Empty string uses the built-in default.
   *
...
/**
 * Describes the message memos.api.v1.InstanceSetting.WritingConfig.
 * Use `create(InstanceSetting_WritingConfigSchema)` to create a new message.
 */
export const InstanceSetting_WritingConfigSchema: GenMessage<InstanceSetting_WritingConfig> = /*@__PURE__*/
...
export enum InstanceSetting_AIProviderType {
   ...
   *
   * @generated from enum value: EDGE = 4;
   */
  EDGE = 4,
}
