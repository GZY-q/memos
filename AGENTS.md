...
| Area | Where | Notes |
| --- | --- | --- |
| Navigation / bookmarks start page | `web/src/modules/navigation/` | Self-contained; config is local-first (IndexedDB/localStorage) with an optional ARCHIVED+PRIVATE memo backup. Audit outside edits in `PATCHES.md`. |
